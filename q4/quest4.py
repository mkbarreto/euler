...
def is_palindromic(n):
    ...
    for i in range(len(n_list)>>1):
        is_pali = is_pali and (n_list[i] == n_list[-(i+1)])
    return is_pali

#putting in function bc break don work
def largest_3dig_pali():
...
p1,p2=largest_3dig_pali()
print("The largest palindromic product of two 3-digit primes is " + str(p1*p2) + ', the product of ' + str(p1) + ' and ' + str(p2))